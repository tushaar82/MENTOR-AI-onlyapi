...
2. Adjust language and phrasing for the target tone
...
4. Generate actionable insights for the parent
    # ========================================================================
    # COMMUNICATION GENERATOR METHODS
    # ========================================================================
    ...
    async def _generate_notification(
        ...
        """Generate notification communication."""
        try:
            # Build prompt for notification generation
            prompt = f"""
Generate a notification for parent-child communication.
...
Requirements:
1. Clear and concise notification message
2. Include relevant context and timing
3. Appropriate tone for notification
4. Call to action if needed
5. Consider the child's current mood
...
{{
    ...
    "suggested_timing": "immediate|specific_time",
...
"""
            ...
            content_request = ContentRequest(
                ...
                student_id=request.student_id,
                context={"context_data": context_data, "language": request.language},
                metadata={"generation_type": "notification"}
            )
            ...
            # Parse response
            try:
                notification_data = json.loads(result.content)
            except json.JSONDecodeError:
                ...
                notification_data = {
                    ...
                    "content": result.content,
                    "tone": Tone.NEUTRAL,
                    "follow_up_actions": ["Acknowledge receipt"],
                    "context_relevance": True,
            ...
            return notification_data, generation_metadata
            
        except Exception as e:
            logger.error(f"Failed to generate notification: {e}")
            return {
                "subject": "Notification",
                "content": f"Unable to generate notification: {str(e)}",
                "tone": Tone.NEUTRAL,
    ...
    async def _generate_alert(
        ...
        try:
            # Build prompt for alert generation
            prompt = f"""
Generate an alert communication for parent-child interaction.
...
Requirements:
1. Clear and urgent alert message
2. Explain the issue or concern
3. Provide immediate action steps
4. Use concerned but supportive tone
5. Include severity level

Format as JSON:
{{
    "subject": "Alert subject",
    "content": "Alert content with details",
...
"""
            ...
            content_request = ContentRequest(
                ...
                student_id=request.student_id,
                context={"context_data": context_data, "language": request.language},
                metadata={"generation_type": "alert"}
            )
            ...
            # Parse response
            try:
                alert_data = json.loads(result.content)
            except json.JSONDecodeError:
                # Fallback alert
                alert_data = {
                    "subject": "Alert",
                    "content": result.content,
                    "tone": Tone.CONCERNED,
                    "follow_up_actions": ["Take immediate action"],
                    "context_relevance": True,
                    "personalization_level": 0.5
                }
            ...
            return alert_data, generation_metadata
            
        except Exception as e:
            logger.error(f"Failed to generate alert: {e}")
            return {
                "subject": "Alert",
                "content": f"Unable to generate alert: {str(e)}",
                "tone": Tone.CONCERNED,
                "follow_up_actions": ["Contact support"],
                "context_relevance": False,
                "personalization_level": 0.0
            }, {"error": str(e)}
    ...
    async def _generate_insight(
        ...
        """Generate insight communication."""
        try:
            # Build prompt for insight generation
            prompt = f"""
Generate an insight communication for parent-child interaction.

Context:
{json.dumps(context_data, indent=2)}
Communication Type: Insight
Language: {request.language}
Priority: {request.priority.value}

Requirements:
1. Share valuable insights about child's progress
2. Use encouraging and supportive tone
3. Include specific observations and patterns
4. Provide constructive suggestions
5. Make it educational and empowering

Format as JSON:
{{
    "subject": "Insight subject",
    "content": "Insight content with observations",
    "tone": "supportive|motivational",
    "suggested_timing": "appropriate_time",
    "follow_up_actions": ["action1", "action2"],
    "context_relevance": true,
    "personalization_level": 0.8
}}
"""
            ...
            content_request = ContentRequest(
                ...
                student_id=request.student_id,
                context={"context_data": context_data, "language": request.language},
                metadata={"generation_type": "insight"}
            )
            ...
            try:
                ...
                insight_data = {
                    ...
                    "follow_up_actions": ["Discuss with child"],
                    "context_relevance": True,
                    "personalization_level": 0.5
                }
    ...
    async def _generate_report(
        ...
        """Generate report communication."""
        try:
            # Build prompt for report generation
            prompt = f"""
Generate a report communication for parent-child interaction.
...
Requirements:
1. Comprehensive summary of performance/progress
2. Include key metrics and achievements
3. Highlight areas of concern and improvement
4. Use neutral and informative tone
5. Provide clear next steps

Format as JSON:
{{
    "subject": "Report subject",
    "content": "Report content with summary",
    "tone": "neutral",
    "suggested_timing": "appropriate_time",
    "follow_up_actions": ["action1", "action2"],
    "context_relevance": true,
...
"""
            ...
            content_request = ContentRequest(
                ...
                student_id=request.student_id,
                context={"context_data": context_data, "language": request.language},
                metadata={"generation_type": "report"}
            )
            ...
            try:
                ...
                report_data = {
                    ...
                    "content": result.content,
                    "tone": Tone.NEUTRAL,
                    "follow_up_actions": ["Review details"],
                    "context_relevance": True,
                    "personalization_level": 0.5
                }
            ...
            return report_data, generation_metadata
            
        except Exception as e:
            logger.error(f"Failed to generate report: {e}")
            return {
                "subject": "Report",
                "content": f"Unable to generate report: {str(e)}",
                "tone": Tone.NEUTRAL,
                "follow_up_actions": ["Try again later"],
                "context_relevance": False,
                "personalization_level": 0.0
    ...
    async def _generate_message(
        ...
        try:
            ...
            prompt = f"""
Generate a message for parent-child communication.
...
Language: {request.language}
Priority: {request.priority.value}
Child Mood: {request.child_mood.value if request.child_mood else 'neutral'}

Requirements:
1. Natural and conversational message
2. Consider child's current mood and context
3. Use appropriate tone based on mood
4. Include relevant personal touches
5. Encourage response and dialogue

Format as JSON:
{{
    "subject": "Message subject",
    "content": "Message content",
    "tone": "supportive|motivational|neutral",
    "suggested_timing": "appropriate_time",
    "follow_up_actions": ["action1", "action2"],
    "context_relevance": true,
    "personalization_level": 0.9
...
"""
            ...
            content_request = ContentRequest(
                ...
                student_id=request.student_id,
                context={"context_data": context_data, "language": request.language},
                metadata={"generation_type": "message"}
            )
            ...
            # Parse response
            try:
                message_data = json.loads(result.content)
            except json.JSONDecodeError:
                # Fallback message
                message_data = {
                    "subject": "Message",
                    "content": result.content,
                    "tone": Tone.SUPPORTIVE,
                    "follow_up_actions": ["Wait for response"],
                    "context_relevance": True,
                    "personalization_level": 0.5
                }
            ...
            return message_data, generation_metadata
            
        except Exception as e:
            logger.error(f"Failed to generate message: {e}")
            return {
                "subject": "Message",
                "content": f"Unable to generate message: {str(e)}",
                "tone": Tone.SUPPORTIVE,
                "follow_up_actions": ["Try again later"],
                "context_relevance": False,
                "personalization_level": 0.0
    ...
    async def _generate_reminder(
        ...
        """Generate reminder communication."""
        try:
            # Build prompt for reminder generation
            prompt = f"""
Generate a reminder communication for parent-child interaction.
...
Requirements:
1. Clear and specific reminder
2. Include what needs to be done
3. Provide timing and deadline information
4. Use supportive and encouraging tone
5. Include helpful context or motivation

Format as JSON:
{{
    "subject": "Reminder subject",
    "content": "Reminder content with details",
    "tone": "supportive",
    "suggested_timing": "specific_time",
    "follow_up_actions": ["action1", "action2"],
    "context_relevance": true,
    "personalization_level": 0.8
}}
"""
            ...
            content_request = ContentRequest(
                ...
                student_id=request.student_id,
                context={"context_data": context_data, "language": request.language},
                metadata={"generation_type": "reminder"}
            )
            ...
            # Parse response
            try:
                reminder_data = json.loads(result.content)
            except json.JSONDecodeError:
                # Fallback reminder
                reminder_data = {
                    "subject": "Reminder",
                    "content": result.content,
                    "tone": Tone.SUPPORTIVE,
                    "follow_up_actions": ["Complete task"],
                    "context_relevance": True,
                    "personalization_level": 0.5
                }
            ...
            return reminder_data, generation_metadata
            
        except Exception as e:
            logger.error(f"Failed to generate reminder: {e}")
            return {
                "subject": "Reminder",
                "content": f"Unable to generate reminder: {str(e)}",
                "tone": Tone.SUPPORTIVE,
                "follow_up_actions": ["Try again later"],
                "context_relevance": False,
                "personalization_level": 0.0
    ...
    async def _generate_encouragement(
        ...
        """Generate encouragement communication."""
        try:
            # Build prompt for encouragement generation
            prompt = f"""
Generate an encouragement communication for parent-child interaction.

Context:
{json.dumps(context_data, indent=2)}
Communication Type: Encouragement
Language: {request.language}
Priority: {request.priority.value}
Child Mood: {request.child_mood.value if request.child_mood else 'neutral'}

Requirements:
1. Warm and encouraging message
2. Acknowledge efforts and progress
3. Highlight strengths and achievements
4. Use celebratory or motivational tone
5. Include specific praise and recognition

Format as JSON:
{{
    "subject": "Encouragement subject",
    "content": "Encouragement content with praise",
...
"""
            ...
            content_request = ContentRequest(
                ...
                student_id=request.student_id,
                context={"context_data": context_data, "language": request.language},
                metadata={"generation_type": "encouragement"}
            )
            ...
            # Parse response
            try:
                encouragement_data = json.loads(result.content)
            except json.JSONDecodeError:
                ...
                encouragement_data = {
                    ...
                    "follow_up_actions": ["Continue support"],
                    "context_relevance": True,
                    "personalization_level": 0.5
                }
            ...
            return encouragement_data, generation_metadata
            
        except Exception as e:
            logger.error(f"Failed to generate encouragement: {e}")
            return {
                "subject": "Encouragement",
                "content": f"Unable to generate encouragement: {str(e)}",
                "tone": Tone.MOTIVATIONAL,
                "follow_up_actions": ["Try again later"],
                "context_relevance": False,
                "personalization_level": 0.0
